...
//    }
//if (modalsize == 'sm') {
//        $('#modaldialogConfirm').addClass('modal-sm');
//    } else if (modalsize == 'lg') {
//        $('#modaldialogConfirm').addClass('modal-lg');
//    }
//    else {
//        $('#modaldialogConfirm').removeClass('modal-lg');
//        $('#modaldialogConfirm').removeClass('modal-sm');
//    }
...
//        $('#bodyOuterMain').css('padding-right', '0px');
//        yesFn(evt);
//        $confirm.modal("hide");
//    });
