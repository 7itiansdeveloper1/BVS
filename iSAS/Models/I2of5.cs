...
namespace ISas.Web.Models
{
    class I2of5
    {
        ...
        private static Image MakeBarcodeImage(string barcodeNumber)
        {
            int width = 420;
            int height = 60;
            ...
            Image barcodeImage = new System.Drawing.Bitmap(width, height, PixelFormat.Format64bppPArgb);
        ...
        public static string GetBase64_I2of5(string barcode)
        {
            Image image = MakeBarcodeImage(barcode);
