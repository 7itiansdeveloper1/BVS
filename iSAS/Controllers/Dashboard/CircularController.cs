...
namespace ISas.Web.Controllers.Dashboard
{
    ...
    public class CircularController : Controller
    {
        ...
        public CircularController(ICommon_NECNRepo noticerepo, ISMSManagementRepo smsMangement)
        {
        ...
        public ActionResult New()
        {
            ...
            model.Function = "SAVE";
            ///model.SelectionGroups.UploadedBy = Session["UserId"].ToString();
        ...
        {
            Session["CurrentUploadDocList"] = null;
            Common_NECN_MainModel model = this._noticeRepo.GetDetailsById( _uploadType, UploadId, Session["UserId"].ToString());
        ...
        {
            return PartialView("~/Views/Common_NECN/_Common_NECN_DispalyToUser.cshtml", this._noticeRepo.GetDetailsById(_uploadType, UploadId, Session["UserId"].ToString()));
        }
