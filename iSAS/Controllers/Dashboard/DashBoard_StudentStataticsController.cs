...
namespace ISas.Web.Controllers.Dashboard
{
    ...
    public class DashBoard_StudentStataticsController : Controller
    {
        ...
        {
            return View(_studstataticsRepo.GetStudentAdmissionDetails()); //
        }
        ...
        {
            return View(_studstataticsRepo.GetFeeCollectionDetails());
        }
        ...
        public ViewResult StudentDozear(string erpNo)
        {
