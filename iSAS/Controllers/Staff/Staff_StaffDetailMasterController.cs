...
namespace ISas.Web.Controllers.Staff
{
    ...
    public class Staff_StaffDetailMasterController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Staff_StaffDetailMaster_CRUD(Staff_StaffDetailMasterModel model, HttpPostedFileBase file)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("NewStaff_StaffDetailMaster", "Staff_StaffDetailMaster");
